...
public class Main {
    ...
    public static void startQuickChat() {
        ...
        do {
            ...
            if (chatChoice == 0) { 
                ...
                JOptionPane.showMessageDialog(null, "Total messages sent (excluding stored/disregarded): " + Message.returnTotalMessages());
            } 
    ...
    public static void sendMessagesLoop(int limit) {
        ...
        while (count < limit) {
            ...
            Message currentMsg = new Message(messageID, messageHash, recipient, messageText, "Sent");
