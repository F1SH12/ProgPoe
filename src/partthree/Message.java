...
public class Message {
    ...
    public Message(String messageID, String messageHash, String recipient, String messageText, String flag) {
        this.messageID = messageID;
        this.messageHash = messageHash;
        this.recipient = recipient;
        this.messageText = messageText;
        this.flag = flag;
        //dedicated lists based on the flag
        MessageManager.populateMessageArrays(this); 
    }
    ...
    public static void storeMessage(Message msg) {
        ...
        String jsonMessage = String.format(
            ...
            msg.messageID, msg.messageHash, msg.recipient, 
            msg.messageText.replace("\"", "\\\"")
        );
        
        try (FileWriter file = new FileWriter("stored_messages.json", true)) {
            file.write(jsonMessage);
            JOptionPane.showMessageDialog(null, "Message saved to stored_messages.json successfully!");
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "An error occurred while storing the message in JSON format: " + e.getMessage());
        }
    }
